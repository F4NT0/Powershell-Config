    ...
    Types = @{
        Directories = @{
            ...
            WellKnown = @{
                ...
                'applicationreferral-subscriber'       = '#FE9900'
                'casemanagement-api'                   = '#FE9900'
                'customercare-subscriber'              = '#FE9900'
                'dash-subscriber'                      = '#FE9900'
                'gcp-subscriber'                       = '#FE9900'
                'orderreferral-subscriber'             = '#FE9900'
                'support-managecase-api'               = '#FE9900'
                'support-managecase-casecreator'       = '#FE9900'
                'support-managecase-subscriber'        = '#FE9900'
                'undefined-subscriber'                 = '#FE9900'
                'case-gateway'                         = '#CC6CE7'
                'case-ingress-api'                     = '#CC6CE7'
                'case-receiver-api'                    = '#CC6CE7'
                'addnotes-processor'                   = '#CC6CE7'
                'managephonepayment-api'               = '#CC6CE7'
                'validateaddress-api'                  = '#CC6CE7'
                'order-history-api'                    = '#FFDE59'
                'order-retrievedetails-api'            = '#FFDE59'
